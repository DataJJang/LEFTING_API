...
<div id="wrap">
    <div class="privacy_box">
        <div class="privacy">
            <h2>01. 수집하는 개인정보의 항목</h2>
            <p>회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공
                을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인
                정보를 필수항목으로 수집하고 있습니다.</p>
            <dl>
                <dt>가. 일반회원가입</dt>
                <dd>성명, 아이디, 비밀번호, 연락처(메일주소, 휴대폰 번호)</dd>
                <dt>나. 방문상담예약 등록시</dt>
                <dd>성명, 아이디, 비밀번호, 연락처(메일주소, 휴대폰 번호)</dd>
                <dt>다. 전화상담예약 등록시</dt>
                <dd>성명, 전화번호, 서비스 이용과정이나 사업처리 과정에서 아래와 같은 정보들이 자동으로 생성되어 수집될 수 있습니다.
                    <div class="txt">IP Address, 쿠키, 방문 일시, 서비스 이용 기록</div>
                </dd>
                <dt>라. 개인정보 수집방법</dt>
                <dd>회사는 다음과 같은 방법으로 개인정보를 수집합니다.
                    <div class="txt">홈페이지, 방문상담예약, 전화상담예약</div>
                </dd>
            </dl>

            <h2>02. 개인정보의 수집 및 이용목적</h2>
            <dl>
                <dt>가. 회원관리</dt>
                <dd>회원제 서비스 이용 및 제한적 본인 확인제에 따른 본인확인,
                    개인식별, 가입의사 확인, 가입 및 가입횟수 제한, 만14세 미
                    만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 추후
                    법정 대리인 본인확인, 분쟁 조정을 위한 기록보존, 불만처리
                    등 민원처리, 고지사항 전달</dd>
                <dt>나. 신규 서비스 개발 및 마케팅·광고에의 활용</dt>
                <dd>신규 서비스 개발 및 맞춤 서비스 제공, 통계학적 특성에 따
                    른 서비스 제공 및 광고 게재, 서비스의 유효성 확인, 이벤트
                    및 광고성 정보 제공 및 참여기회 제공, 접속빈도 파악, 회원
                    의 서비스이용에 대한 통계</dd>
            </dl>
            <h2>03. 개인정보의 공유 및 제공</h2>
            <p>회사는 이용자들의 개인정보를 "2. 개인정보의 수집목적 및
                이용목적"에서 고지한 범위내에서 사용하며, 이용자의 사전
                동의 없이는 동 범위를 초과하여 이용하거나 원칙적으로 이
                용자의 개인정보를 외부에 공개하지 않습니다. 다만, 아래의
                경우에는 예외로 합니다.
            </p>
            <ul class="list01">
            ...
            <ul class="list01">
                <li>수탁업체 : 제이에이스컴퍼니㈜</li>
                <li>위탁업무 내용 : 서비스 운영, 이벤트 경품 배송, 고객상담지원, 인프라 관리, 서비스 개발 및 테스트</li>
                <li>개인정보의 보유 및 이용기간 : 회원탈퇴시 혹은 위탁계약 종료시까지</li>
            </ul>

            <h2>05. 개인정보의 보유 및 이용기간</h2>
            <p>이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용
                목적이 달성되면 지체 없이 파기합니다. 단, 다음의 정보에
                대해서는 아래의 이유로 명시한 기간 동안 보존합니다.</p>
            <dl>
                <dt>가. 회사 내부 방침에 의한 정보보유 사유</dt>
                <dd>
                    <div class="txt">부정이용기록</div>
                    <ul>
                ...
                <dd>상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계
                    법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 관계
                    법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
                    이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용
                    하며 보존기간은 아래와 같습니다.
                    <div class="txt">계약 또는 청약철회 등에 관한 기록</div>
                    <ul class="s_txt">
                        <li>- 보존 이유 : 전자상거래 등에서의 소비자보호에 관한 법률</li>
                        <li>- 보존 기간 : 5년</li>
                    </ul>
                    <div class="txt">대금결제 및 재화 등의 공급에 관한 기록</div>
                    <ul class="s_txt">
                        <li>- 보존 이유 : 전자상거래 등에서의 소비자보호에 관한 법률</li>
                        <li>- 보존 기간 : 5년</li>
                    </ul>
                    <div class="txt">소비자의 불만 또는 분쟁처리에 관한 기록</div>
                    <ul class="s_txt">
                        <li>- 보존 이유 : 전자상거래 등에서의 소비자보호에 관한 법률</li>
                        <li>- 보존 기간 : 3년</li>
                    </ul>
                    <div class="txt">본인확인에 관한 기록</div>
                    <ul class="s_txt">
                        <li>- 보존 이유 : 정보통신망 이용촉진 및 정보보호 등에 관한 법률</li>
                        <li>- 보존 기간 : 6개월</li>
                    </ul>
                    <div class="txt">웹사이트 방문 기록</div>
                    <ul class="s_txt">
                        <li>- 보존 이유 : 통신비밀보호법</li>
                        <li>- 보존 기간 : 3개월</li>
                    </ul>
            ...
            <dl>
                ...
                <dt>나. 회사의 쿠키 사용 목적?</dt>
                <dd>
                    <ul class="list02">
                        <li>- 이용자들이 방문한 쥬비스의 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 뉴스편집, 이용자 규모 등을 파악하여 이용자에게 광고를 포함한 최적화된 맞춤형 정보를 제공하기 위해 사용합니다.</li>
                    </ul>
                </dd>
                ...
                <dd>
                    <ul class="list02">
                        ...
                        <li>- 다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 쥬비스 일부 서비스는 이용에 어려움이 있을 수 있습니다.</li>
            ...
            <dl>
                <dt>가. 비밀번호 암호화</dt>
                <dd>쥬비스 회원 아이디(ID)의 비밀번호는 암호화되어 저장 및 관리되고 있어 본인만이 알고 있으며, 개인정보의 확인 및 변경도 비밀번호를 알고 있는 본인에 의해서만 가능합니다.</dd>
                <dt>나. 해킹 등에 대비한 대책</dt>
                <dd>회사는 해킹이나 컴퓨터 바이러스 등에 의해 회원의 개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을 다하고 있습니다. 개인정보의 훼손에 대비해서 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 이용자들의 개인정보나 자료가 누출되거나 손상되지 않도록 방지하고 있으며, 암호화통신 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 하고 있습니다. 그리고 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있으며, 기타 시스템적으로 보안성을 확보하기 위한 가능한 모든 기술적 장치를 갖추려 노력하고 있습니다.</dd>
                <dt>다. 취급 직원의 최소화 및 교육</dt>
                <dd>회사의 개인정보관련 취급 직원은 담당자에 한정시키고 있고 이를 위한 별도의 비밀번호를 부여하여 정기적으로 갱신하고 있으며, 담당자에 대한 수시 교육을 통하여 쥬비스 개인정보취급방침의 준수를 항상 강조하고 있습니다.</dd>
                <dt>라. 개인정보보호전담기구의 운영</dt>
                <dd>그리고 사내 개인정보보호전담기구 등을 통하여 쥬비스 개인정보취급방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우 즉시 수정하고 바로 잡을 수 있도록 노력하고 있습니다. 단, 이용자 본인의 부주의나 인터넷상의 문제로 ID, 비밀번호 등 개인정보가 유출되어 발생한 문제에 대해 회사는 일체의 책임을 지지 않습니다.</dd>
            </dl>
            ...
            <div class="txt">개인정보 관리책임자</div>
            <ul class="s_txt">
                <li>- 이름 : 민찬호</li>
                <li>- 소속 : 정보보호실</li>
                <li>- 전화 : 02-2651-0441</li>
                <li>- 직위 : 이사</li>
                <li>- 메일 : cs@juvis.co.kr</li>
            </ul>
            <div class="txt">개인정보 관리담당자</div>
            <ul class="s_txt">
                <li>- 이름 : 이수호</li>
                <li>- 소속 : 정보기술팀</li>
                <li>- 전화 : 070-4838-7866</li>
                <li>- 직위 : 사원</li>
                <li>- 메일 : suho416@juvis.co.kr</li>
            </ul>
            ...
            <h2>11. 기타</h2>
            <p>쥬비스에 링크되어 있는 웹사이트들이 개인정보를 수집하는 행위에 대해서는 본 "쥬비스 개인정보취급방침"이 적용되지 않음을 알려 드립니다.</p>
            ...
            <ul class="s_txt">
                <li>- 개인정보취급방침 v2.0</li>
                <li>- 공고일자 : 2012년 1월 16일</li>
                <li>- 시행일자 : 2012년 2월 16일</li>
            </ul>
        </div>
